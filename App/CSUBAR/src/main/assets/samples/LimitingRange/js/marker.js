...
function Marker(poiData) {
   ...
   //math to calculate distance between two objects using two sets of coordinates
    ...
    var dist = 1000 * 12742 * Math.asin(Math.sqrt(a)); // 2 * R; R = 6371 km *1000 to convert back to meters to keep it consistent.
    ...
    //here is where the value of the distance is being passed along. it is called 'dist'.
    this.distanceLabel = new AR.Label(dist.toFixed(2) + " m", 0.8, {
        zOrder: 1,
        translate: {
            y: -0.55
        },
